...
class RequestServiceImplTest {
    ...
    void add_whenUserNotFound_thenReturnNotObjectException() {
        ...
        assertThrows(ObjectNotFoundException.class, () -> service.add(userId, itemRequestDto), "нет пользователя");
    ...
    void findAllOwner_whenUserNotFound_thenReturnNotObjectException() {
        ...
        assertThrows(ObjectNotFoundException.class, () -> service.findAllOwner(userId), "нет пользователя");
    ...
    void findAllNotOwner_whenUserNotFound_thenReturnNotObjectException() {
        ...
        assertThrows(ObjectNotFoundException.class, () -> service.findAllNotOwner(userId, page, size),
    ...
    void findById_whenRequestNotFound_thenReturnNotObjectException() {
        ...
        assertThrows(ObjectNotFoundException.class, () -> service.findById(userId, requestId),
                "нет запроса");
