...
import ru.practicum.shareit.excepсtion.CommentException;
import ru.practicum.shareit.excepсtion.NotObjectException;
import ru.practicum.shareit.excepсtion.NotOwnerException;
...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemRefundDto edit(long userId, long itemId, ItemDto itemDto) {
        Item item = itemDao.findById(itemId).orElseThrow(() -> new NotObjectException("Запись не найдена"));
